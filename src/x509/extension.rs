use der::{Tag, TagClass, FromTlv, FromValue, DerResult};
    ...
    (
        ...
        impl Extension {
            fn from_seq(mut reader: DerReader) -> DerResult<Extension> {
                ...
                if let ExtensionId::Unknown = ext {
                    if critical {
                        // TODO
                        // return der_err!(InvalidVal, "unknown extension: {:?}", extn_id);
                    }
